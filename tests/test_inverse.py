...
class TestInverse(unittest.TestCase):
    ...
    def setUp(self):
        ...
        load_ims = Compose([LoadImaged(KEYS), EnsureChannelFirstd(KEYS), FromMetaTensord(KEYS)])
    ...
    def test_inverse_inferred_seg(self, extra_transform):
        ...
        transforms = Compose([EnsureChannelFirstd(KEYS), SpatialPadd(KEYS, (150, 153)), extra_transform])
