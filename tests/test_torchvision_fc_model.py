...
TEST_CASE_0 = [
    {"model_name": "resnet18", "n_classes": 1, "use_conv": True, "pretrained": False},
    (2, 3, 224, 224),
    (2, 1, 1, 1),
]
...
TEST_CASE_2 = [
    {"model_name": "resnet101", "n_classes": 5, "use_conv": True, "pretrained": False},
    (2, 3, 256, 256),
    (2, 5, 2, 2),
]
...
TEST_CASE_PRETRAINED_0 = [
    {"model_name": "resnet18", "n_classes": 1, "use_conv": True, "pretrained": True},
    (2, 3, 224, 224),
    (2, 1, 1, 1),
...
TEST_CASE_PRETRAINED_2 = [
    {"model_name": "resnet18", "n_classes": 5, "use_conv": True, "pretrained": True},
    (2, 3, 256, 256),
    (2, 5, 2, 2),
    -0.010419349186122417,
]
