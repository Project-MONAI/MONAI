...
TEST_CASE_1 = [
    ...
    {
        'img': np.random.rand(1, 2, 1, 3),
        'seg': np.random.randint(0, 2, size=[1, 2, 1, 3]),
    },
    (2, 3)
]
...
TEST_CASE_2 = [
    ...
    {
        'img': np.random.rand(1, 2, 1, 8, 16),
        'seg': np.random.randint(0, 2, size=[1, 2, 1, 8, 16]),
    },
    (1, 2, 8, 16)
]
...
TEST_CASE_3 = [
    ...
    {
        'img': np.random.rand(1, 1, 16, 8, 1),
        'seg': np.random.randint(0, 2, size=[1, 1, 16, 8, 1]),
    },
    (1, 1, 16, 8)
]
