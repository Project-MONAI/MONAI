...
class TestDecoderOnlyTransformer(unittest.TestCase):
    ...
    def test_compatibility(self):
        ...
        # load from /home/mark/data_drive/monai/generative_checkpoints
        net.load_old_state_dict(
            torch.load("/home/mark/data_drive/monai/generative_checkpoints/decoder_only_transformer.pth"), verbose=True
        )
        ...
        with eval_mode(net):
            ...
            torch.testing.assert_allclose(results, expected, rtol=1e-4, atol=1e-4)
