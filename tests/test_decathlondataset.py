...
class TestDecathlonDataset(unittest.TestCase):
    ...
    def test_values(self):
        ...
        def _test_dataset(dataset):
            ...
            self.assertTrue(f"image_{DictPostFixes.META}" in dataset[0])
        ...
        _test_dataset(data)
        self.assertTrue(data[0][f"image_{DictPostFixes.META}"]["filename_or_obj"].endswith("hippocampus_163.nii.gz"))
        self.assertTrue(data[0][f"label_{DictPostFixes.META}"]["filename_or_obj"].endswith("hippocampus_163.nii.gz"))
