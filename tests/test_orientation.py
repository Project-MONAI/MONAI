...
TEST_CASES = [
    [{'axcodes': 'RAS'},
     np.arange(12).reshape((2, 1, 2, 3)), {'affine': np.eye(4)},
     np.arange(12).reshape((2, 1, 2, 3)), 'RAS'],
    [{'axcodes': 'ALS'},
     np.arange(12).reshape((2, 1, 2, 3)), {'affine': np.diag([-1, -1, 1, 1])},
     np.array([[[[3, 4, 5]], [[0, 1, 2]]], [[[9, 10, 11]], [[6, 7, 8]]]]), 'ALS'],
    [{'axcodes': 'RAS'},
     np.arange(12).reshape((2, 1, 2, 3)), {'affine': np.diag([-1, -1, 1, 1])},
     np.array([[[[3, 4, 5], [0, 1, 2]]], [[[9, 10, 11], [6, 7, 8]]]]), 'RAS'],
    [{'axcodes': 'AL'},
     np.arange(6).reshape((2, 1, 3)), {'affine': np.eye(3)},
     np.array([[[0], [1], [2]], [[3], [4], [5]]]), 'AL'],
    [{'axcodes': 'L'},
     np.arange(6).reshape((2, 3)), {'affine': np.eye(2)},
     np.array([[2, 1, 0], [5, 4, 3]]), 'L'],
    [{'axcodes': 'L'},
     np.arange(6).reshape((2, 3)), {'affine': np.eye(2)},
     np.array([[2, 1, 0], [5, 4, 3]]), 'L'],
    [{'axcodes': 'L'},
     np.arange(6).reshape((2, 3)), {'affine': np.diag([-1, 1])},
    ...
    [{'axcodes': 'LPID', 'labels': tuple(zip('LPIC', 'RASD'))},
     np.zeros((1, 2, 3, 4, 5)), {'affine': np.diag([-1, -0.2, -1, 1, 1])},
