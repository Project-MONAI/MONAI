...
TEST_CASES = [
    ...
    [
        ...
        {
            "affine": create_translate(2, (10, 20,),)
            @ create_rotate(2, (np.pi / 3),)
            @ np.diag([-1, -0.2, 1,])
        },
...
class TestOrientationCase(unittest.TestCase):
    ...
    def test_ornt(
        self, init_param, img, data_param, expected_data, expected_code,
    ):
