...
class TestCreateBoxList(unittest.TestCase):
    ...
    def test_value(self, input_data, mode2, expected_box, expected_area):
        ...
        expected_box_standard_clip, _ = clip_boxes_to_image(expected_box_standard, spatial_size, remove_empty=True)
        assert_allclose(
            expected_box_standard_clip, expected_box_standard[1:, :], type_test=True, device_test=True, atol=0.0
        )
