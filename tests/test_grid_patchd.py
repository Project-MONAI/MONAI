...
TEST_CASE_1 = [{"patch_size": (2, 2), "max_num_patches": 3}, {"image": A}, [A11, A12, A21]]
TEST_CASE_2 = [{"patch_size": (2, 2), "max_num_patches": 5}, {"image": A}, [A11, A12, A21, A22]]
...
TEST_CASE_8 = [{"patch_size": (2, 2), "max_num_patches": 3, "sort_key": "max"}, {"image": A}, [A22, A21, A12]]
TEST_CASE_9 = [{"patch_size": (2, 2), "max_num_patches": 4, "sort_key": "min"}, {"image": A}, [A11, A12, A21, A22]]
TEST_CASE_10 = [{"patch_size": (2, 2), "overlap": 0.5, "max_num_patches": 3}, {"image": A}, [A11, A[:, :2, 1:3], A12]]
TEST_CASE_11 = [
