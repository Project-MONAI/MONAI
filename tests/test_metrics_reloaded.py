...
TEST_CASES_BINARY = [
    ...
    [
        {"metric_name": "False Negatives"},
        [y_pred, y],
        1.0,
    ],
    [
        {"metric_name": "True Positives"},
        [y_pred, y],
        2.0,
    ],
    [
        {"metric_name": "True Negatives"},
        [y_pred, y],
        1.0,
    ],
    [
        {"metric_name": "Youden Index"},
        [y_pred, y],
        0.666654,
    ],
    [
    ...
    [
        {"metric_name": "Normalised Expected Cost"},
        [y_pred, y],
        0.333333,
    ],
    [
    ...
    [
        {"metric_name": "Positive Likelihood Ratio"},
        [y_pred, y],
        66576.03,
    ],
    [
        {"metric_name": "Prediction Overlaps Reference"},
        [y_pred, y],
        1.0,
    ],
    [
        {"metric_name": "Positive Predictive Value"},
        [y_pred, y],
        0.999995,
    ],
    [
    ...
    [
        {"metric_name": "Net Benefit Treated"},
        [y_pred, y],
        0.5,
    ],
    [
        {"metric_name": "Negative Predictive Values"},
        [y_pred, y],
        0.5,
    ],
    [
    ...
    [
        {"metric_name": "False Positives Per Image"},
        [y_pred, y],
        0.0,
    ],
    [
        {"metric_name": "Intersection Over Reference"},
        [y_pred, y],
        0.666664,
    ],
    [
    ...
    [
        {"metric_name": "Topology Precision"},
        [y_pred, y],
        1.0,
    ],
    [
        {"metric_name": "Topology Sensitivity"},
        [y_pred, y],
        1.0,
    ],
    [
        {"metric_name": "Centreline Dice Score"},
        [y_pred, y],
        1.0,
    ],
    [
    ...
    [
        {"metric_name": "Normalised Surface Distance"},
        [y_pred, y],
        1.0,
    ],
    [
        {"metric_name": "Average Symmetric Surface Distance"},
        [y_pred, y],
        0.2,
    ],
    [
        {"metric_name": "Mean Average Surfance Distance"},
        [y_pred, y],
        0.166666,
    ],
    [
...
class TestMetricsReloaded(unittest.TestCase):
    ...
    def test_binary(self, input_param, input_data, expected_val):
        ...
        np.testing.assert_allclose(result.detach().cpu().numpy(), expected_val, rtol=1e-5, err_msg=input_param["metric_name"])
