...
input_param_pretrained = {"spatial_dims": 2, "in_channels": 3, "num_classes": 2, "pretrained": True}
...
TEST_CASE_PRETRAINED_1 = [senet154(**input_param_pretrained)]
TEST_CASE_PRETRAINED_2 = [se_resnet50(**input_param_pretrained)]
TEST_CASE_PRETRAINED_3 = [se_resnet101(**input_param_pretrained)]
TEST_CASE_PRETRAINED_4 = [se_resnet152(**input_param_pretrained)]
TEST_CASE_PRETRAINED_5 = [se_resnext50_32x4d(**input_param_pretrained)]
TEST_CASE_PRETRAINED_6 = [se_resnext101_32x4d(**input_param_pretrained)]
...
class TestPretrainedSENET(unittest.TestCase):
    ...
    @skip_if_quick
    def test_senet_shape(self, net):
        input_data = torch.randn(5, 3, 64, 64)
        expected_shape = (5, 2)
        net.eval()
        with torch.no_grad():
            result = net.forward(input_data)
