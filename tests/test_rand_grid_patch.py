...
TEST_CASE_1 = [{"patch_size": (2, 2), "min_start_pos": 0, "max_num_patches": 3}, A, [A11, A12, A21]]
TEST_CASE_2 = [
    {"patch_size": (2, 2), "min_start_pos": 0, "max_start_pos": 0, "max_num_patches": 5},
    A,
    [A11, A12, A21, A22],
]
...
TEST_CASE_8 = [
    {"patch_size": (2, 2), "min_start_pos": 0, "max_start_pos": 1, "max_num_patches": 1, "sort_key": "max"},
    A,
    [A[:, 1:3, 1:3]],
]
TEST_CASE_9 = [
...
class TestSlidingPatch(unittest.TestCase):
    ...
    def test_split_patch_single_call(self, in_type, input_parameters, image, expected):
        ...
        splitter.R = np.random.RandomState(1234)
