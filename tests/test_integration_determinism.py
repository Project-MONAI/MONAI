...
from monai.transforms import Compose, AddChannel, RandRotate90, RandUniformPatch, ScaleIntensity, ToTensor
...
def run_test(batch_size=64, train_steps=200, device=torch.device("cuda:0")):
    ...
    train_transforms = Compose([AddChannel(), ScaleIntensity(), RandUniformPatch((96, 96)), RandRotate90(), ToTensor()])
