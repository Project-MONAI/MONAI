...
from monai.transforms import Compose, AddChannel, RandRotate90, RandLocSpatialCrop, Rescale, ToTensor
...
def run_test(batch_size=64, train_steps=200, device=torch.device("cuda:0")):
    ...
    train_transforms = Compose([AddChannel(), Rescale(), RandLocSpatialCrop((96, 96)), RandRotate90(), ToTensor()])
