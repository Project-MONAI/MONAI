...
TEST_CASES = [
    [  # shape: (2, 2, 3), (2, 2, 3)
        {"classes": 3, "dim": 2},
        {
            "inputs": torch.tensor([[[[0.1498, 0.1158, 0.3996, 0.3730],
        ...
        1.1850,  # the result equals to -1 + np.log(1 + np.exp(1))
    ],
    [  # shape: (2, 2, 3), (2, 2, 3)
        {"classes": 3, "dim": 2},
        {
            "inputs": torch.tensor([[[[0.0411, 0.3386, 0.8352, 0.2741],
                                      [0.4821, 0.0519, 0.2561, 0.9391],
                                      [0.5954, 0.4184, 0.9160, 0.7977],
                                      [0.0588, 0.9156, 0.1307, 0.9914]],
                                     [[0.8481, 0.0892, 0.2044, 0.8470],
                                      [0.3558, 0.3569, 0.0979, 0.4491],
                                      [0.0876, 0.0929, 0.4040, 0.8384],
                                      [0.5313, 0.3927, 0.4165, 0.1107]],
                                     [[0.7993, 0.6938, 0.3151, 0.8728],
                                      [0.7332, 0.4111, 0.3862, 0.9988],
                                      [0.2622, 0.5002, 0.1905, 0.1644],
                                      [0.6354, 0.0047, 0.1649, 0.7112]]]]),
        ...
        1.0375,  # the result equals to -1 + np.log(1 + np.exp(1))
    ],
    [  # shape: (2, 2, 3), (2, 2, 3)
        {"classes": 3, "dim": 3},
        {
            "inputs": torch.tensor([[[[[0.5977, 0.2767, 0.0591, 0.1675],
        ...
        1.1504,  # the result equals to -1 + np.log(1 + np.exp(1))
    ],
]
