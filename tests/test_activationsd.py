...
for p in TEST_NDARRAYS:
    TEST_CASES.append(
        [
            {"keys": ["pred", CommonKeys.LABEL], "sigmoid": False, "softmax": [True, False], "other": None},
            {"pred": p([[[0.0, 1.0]], [[2.0, 3.0]]]), CommonKeys.LABEL: p([[[0.0, 1.0]], [[2.0, 3.0]]])},
            {"pred": p([[[0.1192, 0.1192]], [[0.8808, 0.8808]]]), CommonKeys.LABEL: p([[[0.0, 1.0]], [[2.0, 3.0]]])},
            (2, 1, 2),
        ]
    )
    ...
    TEST_CASES.append(
        [
            {"keys": ["pred", CommonKeys.LABEL], "sigmoid": False, "softmax": False, "other": [torch.tanh, None]},
            {"pred": p([[[0.0, 1.0], [2.0, 3.0]]]), CommonKeys.LABEL: p([[[0.0, 1.0], [2.0, 3.0]]])},
            {"pred": p([[[0.0000, 0.7616], [0.9640, 0.9951]]]), CommonKeys.LABEL: p([[[0.0, 1.0], [2.0, 3.0]]])},
            (1, 2, 2),
        ]
    )
