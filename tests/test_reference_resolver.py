...
TEST_CASE_WRAPPER = [
    {
        "dataset": {
            "_target_": "Dataset",
            "data": [1, 2],
            ConfigComponentReservedKeys.WRAPPER: {"_target_": "CacheDataset", "_mode_": "callable"},
        },
        "dataset#_target_": "Dataset",
        "dataset#data": [1, 2],
        "dataset#data#0": 1,
        "dataset#data#1": 2,
        f"dataset#{ConfigComponentReservedKeys.WRAPPER}": {"_target_": "CacheDataset", "_mode_": "callable"},
        f"dataset#{ConfigComponentReservedKeys.WRAPPER}#_target_": "CacheDataset",
        f"dataset#{ConfigComponentReservedKeys.WRAPPER}#_mode_": "partial",
    },
    "dataset",
    CacheDataset,
    True,
