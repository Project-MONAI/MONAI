...
from typing import TYPE_CHECKING, Callable, Dict, Optional, Sequence, Iterable
...
class Workflow(IgniteEngine):  # type: ignore[valid-type, misc] # due to optional_import
    ...
    Args:
        ...
        data_loader: Ignite engine use data_loader to run, must be Iterable, typically be torch.DataLoader.
    ...
    def __init__(
        ...
        sampler = data_loader.__dict__["sampler"] if isinstance(data_loader, DataLoader) else None
