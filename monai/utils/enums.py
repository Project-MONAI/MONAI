...
class JITMetadataKeys(StrEnum):
    """
    Keys stored in the metadata file for saved TorchScript or ``torch.export`` models. Some of these are generated
    by the routines and others are optionally provided by users.
    """
