...
def iter_patch_slices(dims: Sequence[int], patch_size: Optional[Sequence[int]], start_pos: Sequence[int] = ()):
    """
...
def get_valid_patch_size(image_size: Sequence[int], patch_size: Optional[Sequence[int]] = None):
    """
