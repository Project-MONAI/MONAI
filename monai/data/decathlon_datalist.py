...
def check_missing_files(datalist: List[Dict], keys: KeysCollection, allow_missing_keys: bool = False):
    """Checks whether some files in the Decathlon datalist are missing.
    It would be helpful to check missing files before a heavy training.
