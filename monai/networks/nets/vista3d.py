...
class VISTA3D(nn.Module):
    ...
    """
    def __init__(self, image_encoder, class_head, point_head):
        super().__init__()
    ...
    def forward(
        ...
        **kwargs,
        ...
        if class_vector is not None:
            ...
            logits = self.NINF_VALUE + torch.zeros(
...
class TwoWayAttentionBlock(nn.Module):
    def __init__(
        ...
        self.mlp = MLPBlock(embedding_dim, mlp_dim, activation, dropout_mode="vista3d")
