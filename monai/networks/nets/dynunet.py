...
#     def forward(self, x):
#         print("Input",self.input_block.conv1.conv)
#         out = self.input_block(x)
#         outputs = [out]

#         for downsample in self.downsamples:
#             print("Down",downsample.conv1.conv)
#             out = downsample(out)
#             outputs.insert(0, out)

#         print("Bottleneck",self.bottleneck.conv1.conv)
#         out = self.bottleneck(out)
#         upsample_outs = []

#         for upsample, skip in zip(self.upsamples, outputs):
#             print("Upsample",upsample.transp_conv.conv,out.shape,skip.shape)
