...
Act.add_factory_callable(
    "relu", lambda: nn.modules.ReLU,
)
Act.add_factory_callable(
    "leakyrelu", lambda: nn.modules.LeakyReLU,
)
Act.add_factory_callable(
    "prelu", lambda: nn.modules.PReLU,
)
