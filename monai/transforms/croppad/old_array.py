...
class Pad(InvertibleTransform):
    """
    TODO: pad supports only the torch.functional.nn.grid_sample modes. We'll need to make the
    resampler be more flexible in this case or catch compatibility issues when executing in
    lazy mode
