...
class InvertibleTrait:
    """
    An interface to indicate that the transform has the capability to process in an inverted
    fashion. This interface can be exteded from by people adapting transforms to the MONAI
    framework as well as by implementors of MONAI transforms.
    """
