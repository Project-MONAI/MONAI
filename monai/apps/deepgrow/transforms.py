...
class SpatialCropForegroundd(MapTransform):
    ...
    Args:
        ...
        align_image_edge: when computing box size with `margin`, whether to align with input image edges.
            default to `True`.
    ...
    def __call__(self, data):
        ...
        box_start, box_end = generate_spatial_bounding_box(
            d[self.source_key], self.select_fn, self.channel_indices, self.margin, self.align_image_edge
        )
