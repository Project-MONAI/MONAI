    ...
    def train(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            gpu_id_for_all: a tuple/list of GPU device IDs to use for the training. Default: None (all available GPUs).
    ...
    def train_parallel(
        ...
        **kwargs: Any,
        ...
        Args:
            configs: configurations that should be trained.
                default: ("2d", "3d_fullres", "3d_lowres", "3d_cascade_fullres").
            gpu_id_for_all: a tuple of GPU device IDs to use for the training. Default: None (all available GPUs).
            kwargs: this optional parameter allows you to specify additional arguments defined in the
                ``train_single_model`` method.
        """
