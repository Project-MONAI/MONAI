...
class nnUNetRunner:
    ...
    def convert_dataset(self):
        try:
            ...
            logger.warning(f"num_input_channels: {num_input_channels}")
            ...
            logger.warning(f"num_foreground_classes: {num_foreground_classes}")
            ...
            logger.error("Input '.yaml' is incorrect.")
            return
