...
- **Predefined Datasets for public medical data**
...
MONAI provides several implementations of numerical optimizations and relevant utilities such as `Novograd` and `LearningRateFinder`.
...
- **Decollate batch data for flexible postprocessings**
