...
from monai.handlers import StatsHandler, TensorBoardStatsHandler, stopping_fn_from_metric, ROC_AUC
...
val_metrics = {metric_name: Accuracy(), 'AUC': ROC_AUC(to_onehot_y=True, add_softmax=True)}
